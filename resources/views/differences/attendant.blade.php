        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Attendant Short/Gain List</h4>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('show.attendant.record', ['transactionId' => $transaction->id]) }}" class="fw-bold">{{ $transaction->difference  }}</a>

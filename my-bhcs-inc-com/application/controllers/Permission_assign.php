...
class Permission_assign extends CI_Controller {
    ...
    public function create(){
        ...
        if($this->form_validation->run() === true) {
             ...
             redirect('permission_assign/edit/'.$role_id);
        }
        else{
    ...
    public function rolelist(){
        ...
        $data['content'] = $this->load->view('permission/roles_list',$data,true);
        $this->load->view('layout/main_wrapper',$data);
    }
    ...
    public function roleedit(){
        ...
        $data['role'] = $this->permisson_model->rolelist();
        $data['content'] = $this->load->view('permission/roleedit',$data,true);
        $this->load->view('layout/main_wrapper',$data);
    }

    public function roleread(){
        $data['module'] = 'Roles';
        $data['title'] = 'Role Information';
        $data['role'] = $this->permisson_model->rolelist();
        $data['content'] = $this->load->view('permission/roleread',$data,true);
        $this->load->view('layout/main_wrapper',$data);
    }
    ...
    public function read($id){
        ...
        $data['role'] = $this->permisson_model->rolelistedit($id);
        $data['modules']= $this->permisson_model->module();
        $data['content'] = $this->load->view('permission/rolelistread',$data,true);
        $this->load->view('layout/main_wrapper',$data);
    }
    ...
    public function showpermission($user_role=null){
        ...
        $m=0;
         foreach($module_all_list as $m_data){
             $account_sub = $this->db->select('*')->from('sub_module')->where('mid',$m_data->id)->where('status', 1)->get()->result();

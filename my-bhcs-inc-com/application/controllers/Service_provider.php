...
class Service_provider extends CI_Controller {
	...
	public function index($episode_id = null){
		$data['module'] = "Episode Services";
		$data['title'] = "Episode Services List";
		#-------------------------------#
		$data['services'] = $this->service_provider_model->read_all_by_episode_id($episode_id);
		$data['content'] = $this->load->view('department/episodes',$data,true);
	...
	//	$data['lang_dprt'] = $this->main_department_model->read_lang_department();
		$data['content'] = $this->load->view('department/patient_services',$data,true);
		$this->load->view('layout/main_wrapper',$data);
	}
 	...
 	public function create(){
		...
		if ($this->form_validation->run() === true) {
			...
			$data['content'] = $this->load->view('department/services_form',$data,true);
			$this->load->view('layout/main_wrapper',$data);
		}
	}
	...
	public function assign(){
		...
		if ($this->form_validation->run() === true) {
			...
			$data['content'] = $this->load->view('department/services_assign',$data,true);
			$this->load->view('layout/main_wrapper',$data);
		}
	}
	...
	public function edit($id = null){
		...
		$data['content'] = $this->load->view('department/service_provider_form',$data,true);
		$this->load->view('layout/main_wrapper',$data);
	}

	public function read($id = null){
		$data['module'] = 'Episode Services';
		$data['title'] = 'Episode Services Information';
		#-------------------------------#
		$data['department'] = $this->main_department_model->read_by_id($id);
		$data['content'] = $this->load->view('department/service_provider_read',$data,true);
		$this->load->view('layout/main_wrapper',$data);
	}


	public function delete($id = null, $episodeId)
	{
		...
		$patientId = $this->episode_model->read_by_id($episodeId)->patientId;
		redirect("episode/services/$episodeId/$patientId");
	}

                    ...
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('human_resources/employee/form/'.$employee->user_id,'class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-xs-9">
                                  <input value="<?php echo $employee->create_date ?>" disabled onfocusout="(this.type='text')" onfocus="(this.type='date')" name="date_of_birth" class="dropdown-month-years form-control" type="text" placeholder="1-1-2010" id="date_of_birth"  value="<?php echo $patient->date_of_birth ?>" autocomplete="off">
                              </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                  <select disabled name='branch' class="form-control" id="user_role" >
                                    ...
                                    <?php foreach ($branches as $mBranch): ?>
                                      <option value="<?php echo $mBranch->name; ?>" <?php if ($employee->branch == $mBranch->name){
                                        echo "selected";
                            ...
                            <div class="form-group row">
                                <label for="lastname" class="col-xs-3 col-form-label">Middle Name<i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input value="<?php echo $employee->middlename ?>" disabled name="" type="text" class="form-control" id="lastname" placeholder="Middle Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input value="<?php echo $employee->address ?>" disabled name="address" type="text" class="form-control" id="address" placeholder="Street Address" value="" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-3">
                                    <input value="<?php echo $employee->city ?>" disabled name="city" type="text" class="form-control" id="city" placeholder="City" value="" autocomplete="off">
                                </div>
                                <div class="col-xs-3">
                                  <?php
                                  $states = [ 'AL', 'AK', 'AS', 'AZ', 'AR', 'CA', 'CO', 'CT', 'DE', 'DC', 'FM', 'FL', 'GA', 'GU', 'HI', 'ID', 'IL', 'IN', 'IA', 'KS', 'KY', 'LA', 'ME', 'MH', 'MD', 'MA', 'MI', 'MN', 'MS', 'MO', 'MT', 'NE', 'NV', 'NH', 'NJ', 'NM', 'NY', 'NC', 'ND', 'MP', 'OH', 'OK', 'OR', 'PW', 'PA', 'PR', 'RI', 'SC', 'SD', 'TN', 'TX', 'UT', 'VT', 'VI', 'VA', 'WA', 'WV', 'WI', 'WY' ];
                                   ?>
                                      <select disabled id = "stateSell"  class="form-control" name="stateSel">
                                ...
                                <div class="col-xs-3">
                                  <input value="<?php echo $employee->zipcode ?>" disabled class="form-control" id="zipcode" name="zipcode" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" type="text" maxlength="5" placeholder="Zip Code" value="">
                                </div>
                              </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input value="<?php echo $employee->cellphone ?>" disabled name="phone" class="form-control" type="tel" placeholder="(123) 456 - 7891" maxlength="16" id="phoneNumber" >
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="mobile" class="col-xs-3 col-form-label">Home Phone<i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input value="<?php echo $employee->homephone ?>" disabled name="home" class="form-control" type="tel" placeholder="(123) 456 - 7891" maxlength="16" id="phoneNumber2">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="phone" class="col-xs-3 col-form-label">Emergency Contact<i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input value="<?php echo $employee->emContact ?>" disabled name="emergency" placeholder="Emergency Contact's Name" class="form-control" type="text" >
                                </div>
                            </div>


                            <div class="form-group row">
                                <label for="mobile" class="col-xs-3 col-form-label">Emergency Contact Phone<i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input value="<?php echo $employee->emPhone ?>" disabled class="form-control" type="tel" placeholder="(123) 456 - 7891" maxlength="16" id="phoneNumber4" name="emergency-number">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                               ...
                               <div class="col-xs-4">
                                 <select disabled id = "disciplineSelect" class="form-control" name="discipline">
                           ...
                           <label for="date_of_birth" class="col-xs-2 col-form-label">Hire Date<i class="text-danger">*</i></label>
                           <div class="col-xs-3">
                               <input value="<?php echo $employee->hire_date ?>" disabled name="hire_date" onfocusout="(this.type='text')" onfocus="(this.type='date')" class="dropdown-month-years form-control" type="text" placeholder="1-1-2010" id="date_of_birth"  value="<?php echo $employee->date_of_birth ?>" autocomplete="off">
                           </div>
                         ...
                         <div class="form-group row">
                           ...
                           <div class="col-xs-9">
                               <input value="<?php echo $employee->date_of_birth?>" disabled onfocusout="(this.type='text')" onfocus="(this.type='date')" name="date_of_birth" class="dropdown-month-years form-control" type="text" placeholder="1-1-2010"  autocomplete="off">
                           </div>
                         ...
                         <div class="form-group row">
                           ...
                           <div class="form-group row">
                               ...
                               <div class="col-xs-9">
                                   <input style="height: 100px"  disabled name="" class="form-control"  placeholder="<?php if (empty($employee->comments)) {
                                     echo "No comments";
                                   } else {
                                     echo $employee->comments;
                            ...
                            <div class="form-group row">
                                <div class="col-sm-offset-3 col-sm-6">
                                    <div class="ui buttons">
                                        <a href="<?php echo base_url('human_resources/employee/form/'.$employee->user_id) ?>" class="ui positive button">Edit</a>
                                    </div>
                                </div>
                            </div>
    ...
    <form action="/product/save" method="post">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add New License</h5>
                  ...
                  <div class="row">
                      <div class="col-md-9 col-sm-12">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-xs-9">
                                      <select class="form-control" name="">
                                        ...
                                        <option value="pc" >Compitent Test<option>
                                        <option value="pc" >Skill Check<option>
                                        <option value="pc" >CPT<option>
                                        <option value="pc" >First Aide<option>
                                        <option value="pc" >BCI<option>
                                        <option value="pc" >STA<option>
                                        <option value="pc" >LPN<option>
                                        <option value="pc" >RN<option>
                                        <option value="pc" >In-Services<option>
                                      </select>
                                  </div>
                              </div>
                              <div class="form-group row">
                                  ...
                                  <div class="col-xs-9">
                                      <input name="date_of_birth" id="certFrom" class="dropdown-month-years form-control" type="text" placeholder="License From Date" id="date_of_birth"   autocomplete="off">
                                  </div>
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-xs-9">
                                      <input name="date_of_birth" id="certFrom" class="dropdown-month-years form-control" type="text" placeholder="License Due Date" id="date_of_birth"   autocomplete="off">
                                  </div>
            ...
            <div class="col-sm-12">
                <div  class="panel panel-default thumbnail">
                    ...
                    <div class="panel-heading no-print">
                        <div class="btn-group">
                            <a disabled class="btn btn-success" data-toggle="modal" data-target="" > <i class="fa fa-plus"></i> Add License</a>
                        </div>
                    </div>
                    <?php } ?>
                                                      ...
                                                      <?php foreach ($licenses as $license): ?>
                                                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                                            ...
                                                            <?php
                                                             ...
                                                             ?>
                                                                <a disabled class="btn btn-xs btn-success"><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="<?= display('view')?>"></i></a>
                                                                <a disabled class="btn btn-xs btn-success" data-toggle="tooltip" title = "Edit"><i class="fa fa-edit"></i></a>
                                                                <a disabled style="display: none" class="btn btn-xs btn-success"><i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="Renew"></i></a>
                                                            <?php } ?>

                                                             <?php
                                                             if($this->permission->method('main_department','delete')->access()){
                                                             ?>
                                                                <a disabled href="<?php echo base_url("license/delete/$license->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-danger"><i class="fa fa-trash"></i></a>
                                                             <?php } ?>

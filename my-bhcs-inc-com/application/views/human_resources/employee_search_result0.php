            ...
            <div class="panel-heading no-print">
                <div class="row">
                    <div class="col-lg-2 col-sm-12">
                        <div class="btn-group">
                          <a class="btn btn-primary" href="<?php echo base_url("human_resources/employee/users") ?>"> <i class="fa fa-list"></i> Employees List</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-12"></div>
                    <?php echo form_open('patient/search3',array('method'=>'get')) ?>
                        <div class="col-lg-5 col-sm-12">
                            <input name="search_text" type="text" class="form-control" id="search_text" placeholder="Employee ID/Name" autocomplete="off">
                        </div>
                        <div class="col-lg-2 col-sm-12">
                            <div class="btn-group">

            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="p-l-30 p-r-30">
                        ...
                        <a style=" font-size: 110%; float: right; margin-top:-50px; margin-right: 10px;" href="<?php echo base_url("patient/edit/$episode->patientId") ?>" class="btn btn-success" name="button">Back</a>
                    </div>

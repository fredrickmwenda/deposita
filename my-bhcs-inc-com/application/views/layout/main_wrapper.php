...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini fixed">
        ...
        <div style="" class="wrapper">
            <header class="main-header">
              ...
              <?php if ($this->session->password_status == 1): ?>
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="#" class="dropdown-toggle" data-toggle="<?php echo $this->session->password_status == 1 ? 'dropdown' : '';  ?>"> <i class="pe-7s-settings"></i></a>
                                <ul class="dropdown-menu">
                                    ...
                                    ?>
                                    <li><a href="<?php echo base_url('setting/'); ?>"><i class="pe-7s-settings"></i>Company Settings</a></li>
                                    <?php } ?>
    ...
    <li class="<?php echo (($this->uri->segment(1) == 'dashboard') ? "active" : null) ?>">
      ...
      <?php else: ?>
        <a><i class="fa fa ti-home"></i> <?php echo display('dashboard') ?></a>
      <?php endif; ?>
    ...
    <li class="treeview  <?php echo ((($this->uri->segment(2) == "employee" && $this->uri->segment(3) == "form") || ($this->uri->segment(2) == "employee" && $this->uri->segment(3) == "")) ? "active" : null) ?>">
        ...
        <ul class="treeview-menu">
            ...
            ?>
            <li class="<?php echo (($this->uri->segment(2) == "employee" && $this->uri->segment(3) == "form")? "active" : null) ?>">

              <?php if ($this->session->password_status == 1): ?>
                <a href="<?php echo base_url("human_resources/employee/form") ?>"><?php echo display('add_employee') ?></a>

              <?php else: ?>

                <a><?php echo display('add_employee') ?></a>
            ...
            ?>
            <li class="<?php echo (($this->uri->segment(2) == "employee" && $this->uri->segment(3) == "")? "active" : null) ?>">

              <?php if ($this->session->password_status == 1): ?>
                <a href="<?php echo base_url("human_resources/employee") ?>"><?php echo display('employee_list') ?></a>

              <?php else: ?>

                <a><?php echo display('employee_list') ?></a>
   ...
   <ul class="treeview-menu">
       ...
       ?>
       <li class="<?php echo (($this->uri->segment(1) == "patient" && $this->uri->segment(2) == "create")? "active" : null) ?>">

         <?php if ($this->session->password_status == 1): ?>
           <a href="<?php echo base_url("patient/create") ?>"><?php echo display('add_patient') ?></a>

         <?php else: ?>

           <a><?php echo display('add_patient') ?></a>
      ...
      <?php } ?>
       ...
       ?>
       <li class="<?php echo (($this->uri->segment(1) == "patient" && $this->uri->segment(2) == "")? "active" : null) ?>">
         <?php if ($this->session->password_status == 1): ?>
           <a href="<?php echo base_url("patient") ?>"><?php echo display('patient_list') ?></a>

         <?php else: ?>

           <a><?php echo display('patient_list') ?></a>
   ...
   <?php } ?>
    ...
    <li class="treeview  <?php echo ((($this->uri->segment(2) == "employee" && $this->uri->segment(3) == "form_user") || ($this->uri->segment(2) == "employee" && $this->uri->segment(3) == "users")) ? "active" : null) ?>">
        ...
        <ul class="treeview-menu">
            ...
            if($this->permission->method('add_employee','create')->access()){
            ?>
            <li class="<?php echo (($this->uri->segment(2) == "employee" && $this->uri->segment(3) == "form_user")? "active" : null) ?>">
              <?php if ($this->session->password_status == 1): ?>
                <a href="<?php echo base_url("human_resources/employee/form_user") ?>">Add User</a>
            ...
            if($this->permission->method('employee_list','read')->access() || $this->permission->method('employee_list','update')->access() || $this->permission->method('employee_list','delete')->access()){
            ?>
            <li class="<?php echo (($this->uri->segment(2) == "employee" && $this->uri->segment(3) == "users")? "active" : null) ?>">
              <?php if ($this->session->password_status == 1): ?>
                <a href="<?php echo base_url("human_resources/employee/users") ?>">Users List</a>
    ...
    <li class="treeview <?php echo (($this->uri->segment(1) == "permission_assign") ? "active" : null) ?>">
        ...
        <ul class="treeview-menu">
          ...
          <?php } ?>
            ...
            ?>
              <li class="<?php echo (($this->uri->segment(1) == "permission_assign" && $this->uri->segment(2) == "rolelist")? "active" : null) ?>">
                <?php if ($this->session->password_status == 1): ?>
                  <a href="<?php echo base_url('permission_assign/rolelist') ?>">Roles List</a>

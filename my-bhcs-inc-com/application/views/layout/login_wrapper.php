...
$settings = $this->db->select("logo, site_align")
    ->get('setting')
    ->row();
?>
<!DOCTYPE html>
                ...
                <div class="view-header">
                    ...
                    <div class="header-title">
                        <span class="logo-mini">
                           <img class="img-fluid" src="<?php echo (!empty($settings->logo)?base_url($settings->logo):base_url("assets/images/logo.png")) ?>" alt="">
                        </span>
                        <h3><?php echo (!empty($logo)?$logo:null) ?></h3>

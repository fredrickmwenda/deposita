    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group">
                    <a class="btn btn-primary" href="<?php echo base_url("main_department") ?>"> <i class="fa fa-list"></i> Skills List</a>
                </div>
            </div>
            <?php } ?>
                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('#','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-xs-3 col-form-label">Skill Name<i class="text-danger">*</i></label>
                                <div class="col-xs-9">

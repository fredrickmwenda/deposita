                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <dl class="dl-horizontal">
                                    <dt>License Id</dt><dd>1</dd>
                                    <dt>License Type</dt><dd>CPT</dd>
                                    <dt>Due Date</dt><dd><?php echo date('d M Y',strtotime($profile->date_of_birth)) ?></dd>
                                    <dt>From Date</dt><dd><?php echo date_diff(date_create($profile->date_of_birth), date_create('now'))->y; ?> Years</dd>

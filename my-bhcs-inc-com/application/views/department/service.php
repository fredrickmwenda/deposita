...
<div class="row">
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            ?>
            <div style="display: none" class="panel-heading no-print">
                <div class="btn-group">
                      <a class="btn btn-success" data-toggle="modal" data-target="#licenseTypeModal" > <i class="fa fa-plus"></i> Add License Type</a>
                </div>
            </div>
            <?php } ?>
                                        ...
                                        <?php if (!empty($disciplines)) { ?>
                                            ...
                                            <?php foreach ($disciplines as $discipline) { ?>
                                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                                    ...
                                                    <td><?php echo (($discipline->status==1)?display('active'):display('inactive')); ?></td>
                                                    ...
                                                    <?php
                                                     ...
                                                     ?>
                                                        ...
                                                        <a href="<?php echo base_url("service/read/$discipline->id") ?>" class="btn btn-xs  btn-success"><i class="fa fa-edit"></i></a>
                                                        <a href="<?php echo base_url("service/delete/$discipline->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-danger"><i class="fa fa-trash"></i></a>
                                                    <?php } ?>

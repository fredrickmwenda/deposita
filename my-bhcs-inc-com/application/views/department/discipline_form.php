                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <input disabled name="name" value="<?php echo $discipline->name ?>" type="text" class="form-control" id="name" placeholder="Branch Name" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <input value="<?php echo $discipline->description ?>" style="height: 100px" disabled name="description" class="form-control"  placeholder="<?php echo display('description') ?>" rows="7"><?php echo $department->description ?></input>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <div class="form-check">
                                    <label class="radio-inline"><input disabled type="radio" name="status" <?php if ($discipline->status == 1) {
                                      echo 'checked';
                                    } ?> value="1" ><?php echo display('active') ?></label>
                                    <label class="radio-inline"><input disabled <?php if ($discipline->status == 0) {
                                      echo 'checked';
                            ...
                            <div class="form-group row">
                                <div class="col-sm-offset-3 col-sm-6">
                                    <div class="ui buttons">
                                        <a href="<?php echo base_url('discipline/edit/'.$discipline->id) ?>" class="ui positive button">Edit</a>
                                    </div>
                                </div>
                            </div>

                    ...
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('permission_assign/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input disabled name="type" type="text" class="form-control" id="lastname" placeholder="<?php echo display('role_name') ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-offset-3 col-sm-6">
                                    <div class="ui buttons">
                                        <a href="<?php echo base_url('/permission_assign/roleedit') ?>" class="ui positive button">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </form>

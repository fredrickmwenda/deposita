        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    <ul id="select_div" style="list-style-type: none; display: block; float: right; margin-top: -35px">
                      <h4 style="display: inline; margin-right: 3px" >Select All</h4>
                      <input onclick="toggle(this);" style="display: inline" type="checkbox" name="select_all" class="checkbox checkbox-success" name="" value="Select all">
                    </ul>
                </div>
            </div>
            <div class="panel-body">
                ...
                foreach ($modules as $key=>$value) {
                    $account_sub = $this->db->select('*')->from('sub_module')->where('mid',$value->id)->where('status', 1)->get()->result();
                    ?>
                    <table class="table table-bordered hidetable">
                        ...
                        <tr>
                            ...
                            <?php if (($value->name == 'Employees') || $value->name == 'Patients'): ?>

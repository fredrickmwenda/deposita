                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('website/setting/create/'.$setting->id,'class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                <label for="copyright_text" class="col-xs-3 col-form-label">Copyright, 2021. All rights reserved, Abdi.</label>
                                <div class="col-xs-9">
                                    <textarea name="copyright_text" class="form-control tinymce"  placeholder="Copyright, 2021. All rights reserved, Abdi. rows="2">Copyright, 2021. All rights reserved, Abdi.</textarea>
                                </div>
                            </div>

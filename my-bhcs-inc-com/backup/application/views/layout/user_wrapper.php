            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="p-l-30 p-r-30">
                        ...
                        <a style=" font-size: 110%; float: right; margin-top:-50px; margin-right: 10px;" href="<?php echo base_url('human_resources/employee/users') ?>" class="btn btn-success" name="button">Back</a>
                    </div>
                </section>
                <!-- Main content -->
                <div class="content">

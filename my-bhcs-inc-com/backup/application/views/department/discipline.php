    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div style="" class="panel-heading no-print">
                <div class="btn-group">
                      <a class="btn btn-success" data-toggle="modal" data-target="#licenseTypeModal" > <i class="fa fa-plus"></i> Add Discipline</a>
                </div>
            </div>
            <?php } ?>
                                                ...
                                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                                    ...
                                                    <?php
                                                     ...
                                                     ?>
                                                        ...
                                                        <a href="<?php echo base_url("discipline/read/$discipline->id") ?>" class="btn btn-xs  btn-success"><i class="fa fa-edit"></i></a>
                                                        <a href="<?php echo base_url("discipline/delete/$discipline->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-danger"><i class="fa fa-trash"></i></a>
                                                    <?php } ?>

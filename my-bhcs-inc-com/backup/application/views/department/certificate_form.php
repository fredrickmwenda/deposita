                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <input disabled name="date_of_birth" id="certFrom" value="<?php echo $episode->episodeFrom ?>" class="dropdown-month-years form-control" type="text" placeholder="" id="date_of_birth"   autocomplete="off">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                  <input disabled id="certTo" value="<?php echo $episode->episodeTo ?>" name="date_of_birth" class="dropdown-month-years form-control" type="text" placeholder="12/5/1290" id="date_of_birth"   autocomplete="off">
                            </div>

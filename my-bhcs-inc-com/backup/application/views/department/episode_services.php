        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div style="" class="panel-heading no-print">
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <a  class="btn btn-success" href="<?php echo base_url("patient/edit/$patientId") ?>" > <i class="fa fa-arrow-left"></i>  Back</a>
                                                ...
                                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                                    ...
                                                    <?php
                                                     ...
                                                     ?>
                                                        ...
                                                        <a href="<?php echo base_url("service_provider/delete/$episodeService->id/$episodeService->episodeId") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-danger"><i class="fa fa-trash"></i></a>

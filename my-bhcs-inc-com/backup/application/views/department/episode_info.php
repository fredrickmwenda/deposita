       ...
       <div class="panel panel-default thumbnail">
           ...
           <div class="panel-body">
               <div class="row">
                   ...
                   <div class="col-sm-1" style="margin-left: 35px" align="center">
                           ...
                           <div style="" class="panel-heading no-print">
                               <div class="">
                                 <div class="row">
                                   <div class="col-sm-6">
                                     <div class="row" >
                                         <h3 class="col-sm-4">From Date:</h3><dd style="margin-top: 1% !important" class="col-sm-6"><?php echo $episode->episodeFrom ?></dd>
                                     </div>
                                   </div>
                                   ...
                                   <div class="col-sm-6">
                                     ...
                                     <div class="row">
                                       <h3 class="col-sm-4">To Date:</h3><dd style="margin-top: 1% !important" class="col-sm-6"><?php echo $episode->episodeTo?></dd>

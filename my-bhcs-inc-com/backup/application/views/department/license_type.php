                                ...
                                <table class="datatable table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>License Type Description</th>
                                            <th>Status</th>
                                            <?php
                                                ...
                                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                                    ...
                                                    <?php
                                                     ...
                                                     ?>
                                                        ...
                                                        <a href="<?php echo base_url("license_type/read/$license->id") ?>" class="btn btn-xs  btn-success"><i class="fa fa-edit"></i></a>
                                                        <a href="<?php echo base_url("license_type/delete/$license->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-danger"><i class="fa fa-trash"></i></a>
                                                    <?php } ?>

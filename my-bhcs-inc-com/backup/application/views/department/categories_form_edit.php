            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('categories/create/'.$category->id,'class="form-inner"') ?>

                        <div class="form-group row">
                            <label for="name" class="col-xs-3 col-form-label">Category Name<i class="text-danger">*</i></label>
                            <div class="col-xs-9">
                                <input name="name" value="<?php echo $category->name ?>" type="text" class="form-control" id="name" placeholder="Branch Name" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <input value="<?php echo $category->description ?>" style="height: 100px" name="description" class="form-control"  placeholder="<?php echo display('description') ?>" rows="7"><?php echo $department->description ?></input>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <div class="form-check">
                                    <label class="radio-inline"><input type="radio" name="status" <?php if ($category->status == 1) {
                                      echo 'checked';
                                    } ?> value="1" ><?php echo display('active') ?></label>
                                    <label class="radio-inline"><input <?php if ($category->status == 0) {
                                      echo 'checked';

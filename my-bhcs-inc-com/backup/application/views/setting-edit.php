                    ...
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('setting/create','class="form-inner form-inner-setting"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="title" type="text" class="form-control" id="title" placeholder="Company Name" value="<?php echo $setting->title ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="description" type="text" class="form-control" id="description" placeholder="Street Address"  value="<?php echo $setting->description ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-3">
                                    <input name="city" type="text" class="form-control" id="city" placeholder="City" value="<?php echo $setting->city ?>" autocomplete="off">
                                </div>
                                <div class="col-xs-3">
                                ...
                                <div class="col-xs-3">
                                  <input value="<?php echo $setting->zipcode ?>" class="form-control" id="zipcode" name="zipcode" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" type="text" maxlength="5" placeholder="Zip Code" value="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="email" type="email" class="form-control" id="email" placeholder="<?php echo display('email')?>"  value="<?php echo $setting->email ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input value="<?php echo $setting->phone ?>" name="cellphone" class="form-control" type="tel" placeholder="(123) 456 - 7891" maxlength="16" id="phoneNumber">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="phone" class="col-xs-3 col-form-label">Fax</label>
                                <div class="col-xs-9">
                                    <input value="<?php echo $setting->fax ?>"  name="fax" class="form-control" type="tel" placeholder="(123) 456 - 7891" maxlength="16" id="phoneNumber2">
                                </div>
                            </div>

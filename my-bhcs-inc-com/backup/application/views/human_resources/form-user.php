                    ...
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('human_resources/employee/form_user/'.$employee->user_id,'class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input type="hidden" name="password" value="initial">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="cellphone" class="form-control" maxlength="16" type="tel" placeholder="(123) 456 - 7891" id="phoneNumber" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <div class="form-check">
                                        <label class="radio-inline">
                                        <input type="radio" checked name="pass" value="Male">Blank Password
                                        </label>
